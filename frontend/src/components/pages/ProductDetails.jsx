...
const ProductDetails = () => {
    ...
    const discountPercentage = Math.round(((999 - productDetail.price) / 999) * 100);
                        ...
                        <div className="space-y-6">
                            ...
                            <div className="">
                                ...
                                {productDetail.stock > 3 ?
                                    <span className="text-sm text-gray-600">{productDetail.stock.toLocaleString()} items left
                                    </span>
                                    :
                                    <span className="text-sm text-red-600">{productDetail.stock.toLocaleString()} items left herry up
                                    </span>
                                }
                            ...
                            <div className="border-t border-b py-4">
                                <div className="flex items-baseline gap-2 mb-1">
                                    <span className="text-4xl font-bold text-gray-900">₹{productDetail.price}</span>
