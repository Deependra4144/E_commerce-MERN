...
function EditProduct() {
    ...
    const onSubmit = async (data) => {
        ...
        console.log('EditProduct submitted', data)
    }
                            ...
                            <div className="grid grid-cols-2 gap-2">
                                {imagePreviews.length > 0 ? (
                                    imagePreviews.map((preview, index) => (
                                        <div key={index} className="w-full h-24 rounded-lg overflow-hidden border border-gray-200 bg-gray-100">
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="rounded-2xl border border-gray-200 bg-white shadow-sm p-6">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div>
                                    <div>
                                        <label className="bg-white text-sm font-semibold relative left-2 top-2">Price *</label>
